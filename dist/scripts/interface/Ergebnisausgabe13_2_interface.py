...
class Noteneingabe11(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle('Ergebnisausgabe der Klasse 13/2')

        main_widget = QWidget()
        main_layout = QVBoxLayout()

        lbl = QLabel('Dies ist Eine geordnete Übersicht aller belegten Fächer, und Noten der<br>Klasse 13/2. Außerdem eine information über den Notenschnitt und die Versätzung.')

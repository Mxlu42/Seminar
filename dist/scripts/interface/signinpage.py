...
class Window(QMainWindow):
    def __init__(self):
        ...
        wid.setLayout(grid)
        wid.setMinimumSize(QSize(350, 150))
        wid.setMaximumSize(QSize(350, 150))
        wid.move(round((500/2)-(350/2)), 350)
        txts = []
    ...
    def save(self):   
        ...
        if txts[2].text().strip() == '':
            QMessageBox.about(self, 'Fehler', 'Bitte geben Sie Ihr Passwort ein!')
            return
        ...
        print(aus)                      #Daten zum vergleichen

...
class Noteneingabe11(QMainWindow):
    def __init__(self):
        db = DBHelp()
        #self.true_faecher = db.getAlleBelegtenFaechern([3])
        ...
        self.setWindowTitle('Ergebnisausgabe der Klasse 12/1')

        main_widget = QWidget()
        main_layout = QVBoxLayout()

        lbl = QLabel('Dies ist Eine geordnete Übersicht aller belegten Fächer, und Noten der<br>Klasse 12/1. Außerdem eine information über den Notenschnitt und die Versätzung.')
